...
<template>
	<header class="main-header">
		...
		<div class="window-controls">
			...
			<button class="window-btn" @click="maximize" title="Maximize">
				<img v-if="!isMaximized" class="square" src="./assets/square.svg" />
				<img v-else class="square" src="./assets/square2.svg" />
			</button>
	...
	<main class="main-content">
		...
		<div class="panels-overlay">
			<PositionPanel v-if="showPositionPanel" :position="positionPanelPos"
				@update:position="pos => updatePanelPosition('position', pos)" @close="turnPositionPanel" />
			<ConfigPanel v-if="showConfigPanel" :position="configPanelPos"
				@update:position="pos => updatePanelPosition('config', pos)" @close="turnConfigPanel" />
		</div>
	</main>
</template>
