<template>
	<Panel title="Config" :position="position" :minimized="minimized" @update:minimized="minimized = $event"
		...
		<div :class="['panel', { minimize: minimized }]">
			<div class="config-panel-content">
				<div class="config-row">
					...
					<CustomDropdown :options="sectorFiles" v-model="selectedSector" />
				</div>
				<div class="config-row">
					<label for="theme-select">Theme:</label>
					<CustomDropdown :options="themes" v-model="selectedTheme" />
				</div>
				<hr class="config-separator" />
				<div class="config-row">
					<div class="radar-list-dropdown">
						<button class="radar-list-toggle" @click="showRadarList = !showRadarList"
							:class="{ open: showRadarList }">
							Radar Options
